...
export const POST = withCSRFProtection(async (request: NextRequest) => {
  ...
  try {
    ...
    console.log(`Subscription canceled: ${subscription.id}, Cancel at period end: ${subscription.cancel_at_period_end}`);
    ...
    try {
      ...
      console.log(`User ${userId} subscription canceled in Firestore`);
    ...
    return ErrorHandler.handleAPIError(error, 'cancel-subscription');
  }
}); 